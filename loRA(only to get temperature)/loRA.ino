...
DallasTemperature light_sensor(&LIGHT);
double tmp;
double light_weight = 2500;
...
void loop() {
  ...
  light_weight = light_sensor.getTempCByIndex(0);
  LoRaNow.loop();
}
